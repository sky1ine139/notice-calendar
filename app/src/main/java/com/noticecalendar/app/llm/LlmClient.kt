...
{"title":"事件标题，20字以内","date":"YYYY-MM-DD 或 null","time":"HH:mm 或 null","end_time":"HH:mm 或 null","all_day":true或false,"location":"地点字符串，未提到则为空字符串","description":"关键补充信息（如需携带的材料、参加对象、注意事项），没有则为空字符串"}
抽取规则：
